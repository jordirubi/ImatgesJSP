<%-- 
    Document   : buscarKeywords
    Created on : 26/10/2018, 02:04:57
    Author     : jrubiralta
--%>
...
<html>
    ...
    <body>
        <h1>Buscar per paraules clau</h1>
	...
	java.util.List<org.me.imatge.Imatge> result = port.searchByKeywords(keywords);
